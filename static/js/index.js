  ...
  function Common() {
    ...
    this.throttle = function (func, wait) {
      var context = void 0,
          ...
          more = void 0,
          result = void 0;
      var whenDone = (0, _underscore.debounce)(function () {
    ...
    this.headerActivate = function (e) {
      var header = $('.header');
    ...
    this.tl.to('.header', 0.4, { autoAlpha: 0, onComplete: function onComplete() {
        $('.header').addClass('fixed active visible');
      } }).to('.header', 0.5, { autoAlpha: 1, onReverseComplete: function onReverseComplete() {
    ...
    value: function mobileActions() {
      ...
      menuChildOpen.click(function () {
        ...
        if (!$(this).siblings('.sub__menu').hasClass('active')) {
          $('.header__menu__link').removeClass('active');
          $('.sub__menu').removeClass('active');
          $(this).siblings('.sub__menu').addClass('active');
      ...
      var $box = $(".header__top__contacts__numbers");

      $win.on("click.Bst", function (event) {
        if ($box.has(event.target).length == 0 && !$box.is(event.target) && phoneBtn.has(event.target).length == 0 && !phoneBtn.is(event.target)) {
